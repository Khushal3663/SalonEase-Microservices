...
import com.khushal.repository.BookingRepository;
...
public class BookingServiceImpl implements BookingService {
    ...
    public Booking createBooking(BookingRequest booking,
        ...
        checkTimeSlotAvailable(salon, bookingStartTime, bookingEndTime);
    ...
    public void checkTimeSlotAvailable(SalonDTO salonDTO, LocalDateTime bookingStartTime, LocalDateTime bookingEndTime) throws Exception {
        LocalDateTime salonStartTime = salonDTO.getOpenTime().atDate(bookingStartTime.toLocalDate());
        LocalDateTime salonCloseTime = salonDTO.getCloseTime().atDate(bookingEndTime.toLocalDate());

        if(bookingStartTime.isBefore(salonStartTime) || bookingEndTime.isAfter(salonCloseTime)){
    ...
    public List<Booking> getBookingsByDate(LocalDate date, Long salonId) {
        System.out.println("Filtering bookings for Salon: " + salonId + " on Date: " + date);
    ...
    public SalonReport getSalonReport(Long salonId) {
        ...
        List<Booking> cancelledBookings = bookings.stream()
                ...
                .toList();
        int refund = cancelledBookings.stream()
                .mapToInt(Booking::getTotalPrice)
                .sum();

        SalonReport salonReport = new SalonReport();
//        salonReport.setName(sa);
    ...
    @Override
    public List<Booking> getAllBookingsByIds(List<Long> ids) {
